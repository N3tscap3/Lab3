package bsu.rfe.java.group6.lab3.ZAMARAEV.var13A;
...
//Показ строки с именем и фамилией
                JOptionPane.showMessageDialog(MainFrame.this, "Замараев Арсений, 6 группа",
...
// со значением по умолчанию 0.0
        textFieldFrom = new JTextField("-10.0", 10);
...
// со значением по умолчанию 1.0
        textFieldTo = new JTextField("10.0", 10);
// Установить максимальный размер равный предпочтительному, чтобы
// предотвратить увеличение размера поля ввода
